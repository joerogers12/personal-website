  ...
  return (
    <>
      ...
      <div className="full-page">
        ...
        {/* Sidebar */}
        <Sidebar sidebarCollapsed={sidebarCollapsed} onClose={() => setSidebarCollapsed(true)} />        
        ...
        <main>
          ...
          <section className="about-me" id="about-me">
            {sidebarCollapsed && (
              <svg 
                id="expand-sidebar" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-caret-left-square" viewBox="0 0 16 16"
